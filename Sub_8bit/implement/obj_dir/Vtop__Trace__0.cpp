...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+1,(vlSelf->top__DOT__dut__DOT__full_adder_4bit_01__DOT__tmp_sub),4);
        ...
        bufp->chgCData(oldp+5,(vlSelf->top__DOT__dut__DOT__full_adder_4bit_02__DOT__tmp_sub),4);
    ...
    bufp->chgBit(oldp+13,((1U & ((((IData)(vlSelf->M_i) 
                                   >> 7U) & (~ ((IData)(vlSelf->N_i) 
                                                >> 7U))) 
                                 | ((((IData)(vlSelf->M_i) 
                                      >> 7U) ^ (~ ((IData)(vlSelf->N_i) 
    ...
    bufp->chgCData(oldp+14,((0xfU & (IData)(vlSelf->M_i))),4);
    bufp->chgCData(oldp+15,((0xfU & (~ (IData)(vlSelf->N_i)))),4);
    bufp->chgBit(oldp+16,((1U & (IData)(vlSelf->M_i))));
    bufp->chgBit(oldp+17,((1U & (~ (IData)(vlSelf->N_i)))));
    bufp->chgBit(oldp+18,((1U & (~ ((IData)(vlSelf->M_i) 
                                    ^ (~ (IData)(vlSelf->N_i)))))));
    bufp->chgBit(oldp+19,((1U & ((IData)(vlSelf->M_i) 
                                 >> 1U))));
    bufp->chgBit(oldp+20,((1U & (~ ((IData)(vlSelf->N_i) 
                                    >> 1U)))));
    ...
    bufp->chgBit(oldp+22,((1U & ((IData)(vlSelf->M_i) 
                                 >> 2U))));
    bufp->chgBit(oldp+23,((1U & (~ ((IData)(vlSelf->N_i) 
                                    >> 2U)))));
    ...
    bufp->chgBit(oldp+25,((1U & ((IData)(vlSelf->M_i) 
                                 >> 3U))));
    bufp->chgBit(oldp+26,((1U & (~ ((IData)(vlSelf->N_i) 
                                    >> 3U)))));
    bufp->chgBit(oldp+27,((1U & ((((IData)(vlSelf->M_i) 
                                   >> 3U) ^ (~ ((IData)(vlSelf->N_i) 
                                                >> 3U))) 
                                 ^ (IData)(vlSelf->top__DOT__dut__DOT__full_adder_4bit_01__DOT__full_adder_03__DOT__carry)))));
    bufp->chgCData(oldp+28,((0xfU & ((IData)(vlSelf->M_i) 
                                     >> 4U))),4);
    bufp->chgCData(oldp+29,((0xfU & (~ ((IData)(vlSelf->N_i) 
                                        >> 4U)))),4);
